...
function MainPage({ getMessage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await getMessage({ temperature, top_p });
  ...
  return (
    ...
    <form className='max-w-[500px] mx-auto' onSubmit={handleSubmit}>
      ...
      {/* <textarea type='text' name='userInput' placeholder="user input" rows={20} className='border-2 border-gray-300 p-2 rounded-md w-full mb-4' /> */}
